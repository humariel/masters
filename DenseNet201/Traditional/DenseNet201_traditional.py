## BASE MODEL AND DATA AUGMENTATION WITH SHIFTS AND MIRRORS ##
...
def main(halve):
    ...
    if halve:
        model_name = 'densenet_traditional_halved.h5'
        history_name = "history_traditional_halved.p"
    else:
        model_name = 'densenet_traditional.h5'
        history_name = "history_traditional.p"
    ...
    val_steps_per_epoch = val_x.shape[0] // BATCH_SIZE
