...
CIFAR_FAKE_DIR = BASE_DIR + "/cifar-10-generated_acgan/"
...
def main(halve):
    ...
    if halve:
        model_name = 'BaseClf_fake2_halved.h5'
        history_name = "BaseClf_fake2_halved.p"
    else:
        model_name = 'BaseClf_fake2.h5'
        history_name = "BaseClf_fake2.p"
